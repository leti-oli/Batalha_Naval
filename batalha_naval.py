...
gabarito_J = []
gabarito_C = []
#listas para armazenar as posições das embarcações e facilitar a demonstração do código
...
def menu():
    ...
    print("- Na sua vez, você deve escolher as coordenadas X (linhas 0 a 4) e Y (0 a 9) para atacar o adversário.")
